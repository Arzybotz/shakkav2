...
David dono da base e q fez praticamente todos os comandos wa.me/553484104285
ikyy (Base)
		...
		if (isRegister) return 
		    ...
		    ikyy.sendMessage(from, teks, text, {quoted: freply })
               ...
               case 'criador':  
		            ...
		            + `FN:David\n`
		            + `ORG: dono do David;\n`
		            + `TEL;type=CELL;type=VOICE;waid=553484104285:55 3484104285\n`
		            + 'END:VCARD'.trim()
...
//jogos
         case 'luta':
               if (isGame(sender, isPremium, gcount, glimit)) return reply(`Seu limite de jogo acabou, se quiser jogar sem ter limites fale com o wa.me/553484104285`)
...
case 'smoke':
                    ...
                    if (args.length == 0) return reply(`exemplo: ${prefix + command} David-D`)
                    teka = args.join(" ")
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								...
								exec(`webpmux -set exif ${addMetadata('@rdavid.js', 'David')} ${ran} -o ${ran}`, async (error) => {

									if (error) return reply(mess.error.stick)

									ikyy.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": `AQUI ESTÁ A SUA FIGURINHA`, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", 'jpegThumbnail': fs.readFileSync('sticker/botlogo.webp')}}}})
       ...
       case 'swm':
            ...
            _out = getRandom('.webp')
             ...
             .save(out)       
              ...
              reply(`vc deve enviar assim !swm keyy|aaa`)
}
              break 
      case 'toimg':
              if (!isQuotedSticker) return reply('marque o sticker')
...
case 'bc':
      case 'broadcast':
             ...
             ikyy.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「  keyy™ 」*\n\n${body.slice(4)}`})
}
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'report':
              ...
              ikyy.sendMessage('553484104285@s.whatsapp.net',`*Relatório de erro:* ${teks}`, text)
              break
       case 'readall':
       case 'lertd':
...
case 'creditos':
case 'ajuda':
             reply(`esses são os créditos da base:\naqui estão alguns dos créditos 👇👇\nDavid dono da base e q fez praticamente todos os comandos wa.me/553484104285\n🃏T o b i ϟϟ sempre ajudando em uns testes wa.me/553484104285`)
             break 
...
.on('end', function() {
console.log('Finish')
exec(`webpmux -set exif ${addMetadata('keyy', 'keyy')} ${ran} -o ${ran}`, async(error) => {
ikyy.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: mek})
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
